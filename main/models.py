...
class MedicalResult(models.Model):
    ...
    prescription = models.TextField(verbose_name='Медицинское назначение', null=True)
    comments = models.TextField(verbose_name='Комментарий', null=True)
...
class MedicalResultFile(models.Model):
    ...
    file_description = models.CharField(max_length=50, verbose_name='Описание файла', null=True)
    file = models.FileField(upload_to='medical_results/', null=True)
